...
function preload(){
	...
	howToPlaypopup3Img = loadAnimation("assets/howtoplaypopup3.png");
	howToPlaypopup4Img = loadAnimation("assets/howtoplaypopup4.png");
	...
	//sound
	buttonclicksound = loadSound("assets/sounds/buttonclick.wav");
	watersound = loadSound("assets/sounds/watersound.mp3");
	themesound = loadSound("assets/sounds/theme.mp3");
	gameoverssound = loadSound("assets/sounds/gameover1.wav");
	gamewinsound = loadSound("assets/sounds/gamewin1.wav");
	enemysound = loadSound("assets/sounds/wrong.mp3");
	lastsound = loadSound("assets/sounds/gamewin.mp3");
	jumpsound = loadSound("assets/sounds/jump.wav");
	howToPlaySound = loadSound("assets/sounds/howToPlay.wav");
	lifeDecreaseSound = loadSound("assets/sounds/lifeDecrease.wav");
...
function setup() {
  ...
  if(isMobile){
	...
	howToPlaypopup = createSprite(width/2,height/2);
	howToPlaypopup.addAnimation("pop1", howToPlaypopup1Img);
	howToPlaypopup.addAnimation("pop2", howToPlaypopup2Img);
	howToPlaypopup.addAnimation("pop3", howToPlaypopup3Img);
	howToPlaypopup.addAnimation("pop4", howToPlaypopup4Img);
	howToPlaypopup.changeAnimation("pop1");
	howToPlaypopup.scale = 1.3
...
function gameStart(){
	if(gameState === "START"){
		...
		if(mousePressedOver(howToPlaypopup)){
			howToPlaypopup.visible = false;
			howToPlaySound.play();
		}
		}
...
function level1Setup(){
	if(gameState==="Level-1-Setup"){
		...
		if(mousePressedOver(howToPlay)){
			howToPlaypopup.changeAnimation("pop2");
			howToPlaypopup.visible = true;
			howToPlaySound.play();
...
function finalScreen(){
	if (gameState === "FinalScreen"){
		...
		if(mousePressedOver(howToPlay)){
			howToPlaypopup.changeAnimation("pop4");
			howToPlaypopup.visible = true;
			howToPlaySound.play();
